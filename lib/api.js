...
export async function getNft() {
    const options = {
        method: 'GET',
        headers: { Accept: 'application/json', 'X-API-KEY': `6324181d24f24006bd9f429ff086ea7a` }
    };

    try {
        const res1 = await fetch(
            "https://api.opensea.io/api/v1/assets?order_by=sale_date&order_direction=desc&offset=0&limit=12", options
        ).then((res1) => res1.json());
