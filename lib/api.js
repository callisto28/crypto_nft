export async function getTenCrypto(context) {
    ...
    try {
        const res = await fetch(`https://api.nomics.com/v1/currencies/ticker?key=a7aa7ea4b3e128b4497f815cd1aa2c9198e51909&interval=1d,30d&convert=EUR&rank&per-page=15&page=1`
        ).then((res) => res.json());
